...
exports.GeneTracks = void 0;
const defaultGeneTooltip = {
    closeable: false,
...
const defaultGeneMouseBehavior = {
    onmouseover: [
...
class GeneTracks extends LocusZoom.DataLayers.get("BaseDataLayer") {
    ...
    render() {
        ...
        selection.enter()
            ...
            // exons.enter()
            //     .append('rect')
            //     .attr('class', 'lz-data_layer-genes lz-gene')
            //     .merge(exons)
    ...
    _getTooltipPosition(tooltip) {
        ...
        const gene_bbox = d3.select(`#${gene_bbox_id}`)
            .node().getBBox();
        return {
