...
const INNER_BORDER = 'rgb(210, 210, 210)';
 ...
 */
function locusAssoc(dataNamespace, chr, xfield, yfield, sigVal) {
    ...
    panel_struct.data_layers.push(PlabDataLayers.associationPvalues(dataNamespace, xfield, yfield));
    panel_struct.data_layers.push(PlabDataLayers.significance(sigVal));
    return panel_struct;
}
/**
 *
...
function chrAssoc(dataNamespace, chr, xfield, yfield) {
    ...
    panel_struct.data_layers.push(PlabDataLayers.chrOverview(dataNamespace, xfield, yfield));
    return panel_struct;
}
export { genes, locusAssoc, chrAssoc };
